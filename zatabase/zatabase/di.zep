...
use ZataBase\Di\Service;
use ZataBase\Di\ServiceInterface;
use ZataBase\Di\Exception;

/**
 * ZataBase\Di
 *
 * ZataBase\Di is a component that implements Dependency Injection/Service Location
 * of services and it"s itself a container for them.
 *
 * Since Phalcon is highly decoupled, ZataBase\Di is essential to integrate the different
 ...
 * $di->set("request", "ZataBase\Http\Request", true);
 *
 * //Using an anonymous function
 * $di->set("request", function(){
 *	  return new \ZataBase\Http\Request();
 * }, true);
 *
...
class Di implements DiInterface
{
	 ...
	 * @return ZataBase\Di\ServiceInterface
	 */
	 ...
	 * @param mixed definition
	 * @param boolean shared
	 * @return ZataBase\Di\ServiceInterface|false
	 */
	...
	/**
	 * Sets a service using a raw ZataBase\Di\Service definition
	 *
	 * @param string name
	 * @param ZataBase\Di\ServiceInterface rawDefinition
	 * @return ZataBase\Di\ServiceInterface
	 */
	...
	/**
	 * Returns a ZataBase\Di\Service instance
	 *
	 * @param string name
	 * @return ZataBase\Di\ServiceInterface
	 */
	...
	public function get(string! name, parameters = null)
	{
		...
		/**
		 * Pass the DI itself if the instance implements \ZataBase\Di\InjectionAwareInterface
		 */
	 ...
	 *
	 *<code>
	 *	$di["request"] = new \ZataBase\Http\Request();
	 *</code>
	 *
	 * @param string name
	 * @param mixed definition
